...
def process_image(path, out_path):
    ...
    # for i in range(4):
    #     edges = dilate(edges, N=3, iterations=2)
    #     edges = erode(edges, N=3, iterations=2)

    edges = dilate(edges, N=3, iterations=3)
...
def process_image2():
    ...
    # for b in borders:
    #     cv2.rectangle(edges, (b[1], b[2]), (b[3], b[4]), (255,255,255), -1)
    #
    # edges = dilate(edges, N=3, iterations=3)
    Image.fromarray(edges).show()
    show_image_contours(edges)
